...
The Ruby SDK for the IndoorEnvironmentalMonitoring API. Provides an entity-oriented interface using idiomatic Ruby conventions.
...
result, err = client.IndoorEnvironmentalMonitoring(nil).load(
  { "id" => "test01" }, nil
)
