# IndoorEnvironmentalMonitoring SDK — README + REFERENCE example snippet tests.
#
...
#      (IndoorEnvironmentalMonitoringSDK.test) seeded with an in-memory fixture for every
