...
#      offline in seeded test mode (IndoorEnvironmentalMonitoringSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "IndoorEnvironmentalMonitoring_sdk.rb")
  SDK_CLASS = "IndoorEnvironmentalMonitoringSDK"
  ...
  SDK_BASE = "IndoorEnvironmentalMonitoring_sdk"
