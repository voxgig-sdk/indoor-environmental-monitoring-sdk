# IndoorEnvironmentalMonitoring SDK feature corpus test
#
...
class FeatureCorpusTest < Minitest::Test
  ...
  #
  # IndoorEnvironmentalMonitoringSDK.new, not IndoorEnvironmentalMonitoringSDK.test: the `test` feature is
  ...
  def build_client(kase)
    ...
    IndoorEnvironmentalMonitoringSDK.new(opts)
  end
