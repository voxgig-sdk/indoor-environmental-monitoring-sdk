...
AQL-driven CLI and REPL for the IndoorEnvironmentalMonitoring SDK. Positional arguments are
...
```sh
go build -o indoor-environmental-monitoring-cli ./...
```
...
./indoor-environmental-monitoring-cli load 1 environmental_monitoring
./indoor-environmental-monitoring-cli load '{id:1}' environmental_monitoring
