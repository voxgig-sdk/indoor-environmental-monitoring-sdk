...
AQL-driven command-line client **and** interactive REPL for the IndoorEnvironmentalMonitoring
...
- `<entity>` is a bareword, auto-quoted as an AQL atom (e.g. `environmental_monitoring`).
