...
func registerSDKWords(r *eng.Registry, client *sdk.IndoorEnvironmentalMonitoringSDK) {
...
func runOp(client *sdk.IndoorEnvironmentalMonitoringSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
