...
Results: Successful response with environmental monitoring data.
...
| --- | --- | --- | --- |
| EnvironmentalMonitoring | `list` | `GET /flat/EnvironmentStation` | See reference |

## Connect to the API

- Open Data Hub API Server: `https://mobility.api.opendatahub.com/v2`
...
- `indoor-environmental-monitoring_list`: List records for an entity. Supported entities: `environmental_monitoring`.
- `indoor-environmental-monitoring_load`: Load one record for an entity. No active entity supports this operation.
