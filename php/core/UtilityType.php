...
// IndoorEnvironmentalMonitoring SDK utility type

class IndoorEnvironmentalMonitoringUtility
{
    ...
    public static function copy(IndoorEnvironmentalMonitoringUtility $src): IndoorEnvironmentalMonitoringUtility
    {
        $u = new IndoorEnvironmentalMonitoringUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
