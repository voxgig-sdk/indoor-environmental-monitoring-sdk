...
// IndoorEnvironmentalMonitoring SDK ratelimit feature
...
class IndoorEnvironmentalMonitoringRatelimitFeature extends IndoorEnvironmentalMonitoringBaseFeature
{
    ...
    private function _acquire(IndoorEnvironmentalMonitoringContext $ctx): void
    {
    ...
    private function _track(IndoorEnvironmentalMonitoringContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
