...
// IndoorEnvironmentalMonitoring SDK rbac feature
...
class IndoorEnvironmentalMonitoringRbacFeature extends IndoorEnvironmentalMonitoringBaseFeature
{
    ...
    private function _required(IndoorEnvironmentalMonitoringContext $ctx): ?string
    {
    ...
    private function _reject(IndoorEnvironmentalMonitoringContext $ctx, string $required): void
    {
    ...
    private function _track(IndoorEnvironmentalMonitoringContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
