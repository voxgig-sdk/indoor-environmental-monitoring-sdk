...
// IndoorEnvironmentalMonitoring SDK netsim feature
...
class IndoorEnvironmentalMonitoringNetsimFeature extends IndoorEnvironmentalMonitoringBaseFeature
{
    ...
    private function _simulate(IndoorEnvironmentalMonitoringContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(IndoorEnvironmentalMonitoringContext $ctx, array $applied): void
    {
        $client = $this->client;
