...
// IndoorEnvironmentalMonitoring SDK proxy feature
...
class IndoorEnvironmentalMonitoringProxyFeature extends IndoorEnvironmentalMonitoringBaseFeature
{
    ...
    public function init(IndoorEnvironmentalMonitoringContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (IndoorEnvironmentalMonitoringContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
