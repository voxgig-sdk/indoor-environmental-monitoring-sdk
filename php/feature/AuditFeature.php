...
// IndoorEnvironmentalMonitoring SDK audit feature
...
class IndoorEnvironmentalMonitoringAuditFeature extends IndoorEnvironmentalMonitoringBaseFeature
{
    ...
    private function _emit(IndoorEnvironmentalMonitoringContext $ctx, string $outcome): void
    {
