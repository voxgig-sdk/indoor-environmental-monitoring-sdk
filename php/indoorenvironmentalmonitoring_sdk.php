...
class IndoorEnvironmentalMonitoringSDK
{
    public string $mode;
    ...
    public function __construct(array $options = [])
    {
        ...
        $feature_opts = IndoorEnvironmentalMonitoringHelpers::to_map(Struct::getprop($this->options, "feature"));
        if ($feature_opts) {
            $featureorder = Struct::getpath($this->options, "__derived__.featureorder");
            if (is_array($featureorder)) {
                foreach ($featureorder as $fname) {
                    $fopts = IndoorEnvironmentalMonitoringHelpers::to_map($feature_opts[$fname] ?? null);
                    if ($fopts && isset($fopts["active"]) && $fopts["active"] === true) {
                        ...
                        if (!IndoorEnvironmentalMonitoringFeatures::has_feature($fname)) {
                        ...
                        ($utility->feature_add)($this->_rootctx, IndoorEnvironmentalMonitoringFeatures::make_feature($fname));
                    }
                }
            }
        }
    ...
    {
        return IndoorEnvironmentalMonitoringUtility::copy($this->_utility);
    }
    ...
    public function prepare(array $fetchargs = []): mixed
    {
        ...
        $ctrl = IndoorEnvironmentalMonitoringHelpers::to_map(Struct::getprop($fetchargs, "ctrl")) ?? [];
        ...
        $params = IndoorEnvironmentalMonitoringHelpers::to_map(Struct::getprop($fetchargs, "params")) ?? [];
        $query = IndoorEnvironmentalMonitoringHelpers::to_map(Struct::getprop($fetchargs, "query")) ?? [];
    ...
    private function op_denied(string $op): array
    {
        ...
        return [
            "ok" => false,
            "err" => new IndoorEnvironmentalMonitoringError($op . "_allow",
                "IndoorEnvironmentalMonitoringSDK: " . $op . ": operation not allowed by" .
    ...
    private function raw_request(array $fetchargs = []): mixed
    {
        ...
        if (is_array($fetched)) {
            $status = IndoorEnvironmentalMonitoringHelpers::to_int(Struct::getprop($fetched, "status"));
    ...
    public function graphql(string $query, ?array $variables = null, ?array $ctrl = null): mixed
    {
        ...
        if (is_array($errors) && 0 < count($errors)) {
            ...
            $res["ok"] = false;
            $res["err"] = new IndoorEnvironmentalMonitoringError("graphql_error",
                "IndoorEnvironmentalMonitoringSDK: graphql: " . $msg);
            $res["graphql"] = $errors;
        }
    ...
    public function EnvironmentalMonitoring($data = null)
    {
        ...
        if ($data === null) {
            if ($this->_environmental_monitoring === null) {
                $this->_environmental_monitoring = new EnvironmentalMonitoringEntity($this, null);
            }
            return $this->_environmental_monitoring;
        }
        return new EnvironmentalMonitoringEntity($this, $data);
    }
    ...
    public static function test(?array $testopts = null, ?array $sdkopts = null): self
    {
        ...
        $sdk = new IndoorEnvironmentalMonitoringSDK($sdkopts);
        $sdk->mode = "test";
        return $sdk;
    }
}
