# IndoorEnvironmentalMonitoring PHP SDK



The PHP SDK for the IndoorEnvironmentalMonitoring API — an entity-oriented client using PHP conventions.
...
try {
    ...
    foreach ($environmentalmonitorings as $record) {
...
print_r(array_map(fn($item) => $item->data_get(), $environmentalmonitoring));
```
...
```
php/
├── indoorenvironmentalmonitoring_sdk.php          -- Main SDK class
...
The main class (`indoorenvironmentalmonitoring_sdk.php`) exports the SDK class
