...
The PHP SDK for the IndoorEnvironmentalMonitoring API. Provides an entity-oriented interface using PHP conventions.
...
```php
[$result, $err] = $client->EnvironmentalMonitoring(null)->list(null, null);
...
[$result, $err] = $client->IndoorEnvironmentalMonitoring(null)->load(
    ["id" => "test01"], null
);
