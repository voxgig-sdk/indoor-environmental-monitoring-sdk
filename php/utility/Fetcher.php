...
// IndoorEnvironmentalMonitoring SDK utility: fetcher

class IndoorEnvironmentalMonitoringFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; IndoorEnvironmentalMonitoringSDK/1.0)';
    ...
    public static function call(IndoorEnvironmentalMonitoringContext $ctx, string $fullurl, array $fetchdef): array
    {
