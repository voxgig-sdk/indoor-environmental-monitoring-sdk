...
// IndoorEnvironmentalMonitoring SDK utility: make_spec

require_once __DIR__ . '/Graphql.php';

require_once __DIR__ . '/../core/Spec.php';

class IndoorEnvironmentalMonitoringMakeSpec
{
    public static function call(IndoorEnvironmentalMonitoringContext $ctx): array
    {
        ...
        if ('graphql' === \Voxgig\Struct\Struct::getprop($point, 'kind')) {
            ...
            $ctx->spec->query = [];
            $ctx->spec->headers['content-type'] = IndoorEnvironmentalMonitoringGraphql::CONTENT_TYPE;
        } else {
