...
class EnvironmentalMonitoringDirectTest extends TestCase
{
    public function test_direct_list_environmental_monitoring(): void
    {
        $setup = environmental_monitoring_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-environmental_monitoring", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
