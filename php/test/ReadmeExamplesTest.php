...
// IndoorEnvironmentalMonitoring SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (IndoorEnvironmentalMonitoringSDK::test)
...
{
    private const SDK_CLASS = 'IndoorEnvironmentalMonitoringSDK';
    ...
    private const SDK_BASE = 'indoorenvironmentalmonitoring_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../indoorenvironmentalmonitoring_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
