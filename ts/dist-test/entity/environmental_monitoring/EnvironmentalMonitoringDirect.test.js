...
(0, node_test_1.describe)('EnvironmentalMonitoringDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.IndoorEnvironmentalMonitoringSDK({
    ...
    (0, node_test_1.test)('direct-list-environmental_monitoring', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-environmental_monitoring', setup.live))
            return;
...
function liveScenariosActive() { return false && process.env.INDOOR_ENVIRONMENTAL_MONITORING_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.IndoorEnvironmentalMonitoringSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['INDOOR_ENVIRONMENTAL_MONITORING_TEST_ENVIRONMENTAL_MONITORING_ENTID'];
    ...
    const client = new __1.IndoorEnvironmentalMonitoringSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=EnvironmentalMonitoringDirect.test.js.map