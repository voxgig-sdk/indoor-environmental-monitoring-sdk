...
class EnvironmentalMonitoringEntity extends IndoorEnvironmentalMonitoringEntityBase_1.IndoorEnvironmentalMonitoringEntityBase {
    constructor(client, entopts) {
        ...
        this.name = 'environmental_monitoring';
        this.name_ = 'environmental_monitoring';
        this.Name = 'EnvironmentalMonitoring';
    }
    make() {
        return new EnvironmentalMonitoringEntity(this._client, this.entopts());
    }
    async list(reqmatch, ctrl) {
        ...
        try {
            ...
            if (err) {
                ...
                // Promise<EnvironmentalMonitoring[]> return stays clean under strict null checks.
                return undefined;
            }
        }
    }
}
exports.EnvironmentalMonitoringEntity = EnvironmentalMonitoringEntity;
//# sourceMappingURL=EnvironmentalMonitoringEntity.js.map