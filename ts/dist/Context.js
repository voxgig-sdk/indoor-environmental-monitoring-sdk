...
const IndoorEnvironmentalMonitoringError_1 = require("./IndoorEnvironmentalMonitoringError");
...
class Context {
    ...
    error(code, msg) {
        return new IndoorEnvironmentalMonitoringError_1.IndoorEnvironmentalMonitoringError(code, msg, this);
    }
    toJSON() {
        return {
            id: this.id,
