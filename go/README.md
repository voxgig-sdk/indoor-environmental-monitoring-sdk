...
The Golang SDK for the IndoorEnvironmentalMonitoring API. Provides an entity-oriented interface using standard Go conventions — no generics required, data flows as `map[string]any`.
