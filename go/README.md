# IndoorEnvironmentalMonitoring Golang SDK
...
## Install
```bash
go get github.com/voxgig-sdk/indoor-environmental-monitoring-sdk/go@latest
```

The Go module proxy resolves the version from the `go/vX.Y.Z` GitHub
release tag — see [Releases](https://github.com/voxgig-sdk/indoor-environmental-monitoring-sdk/releases) for the available versions.
...
```bash
go mod edit -replace github.com/voxgig-sdk/indoor-environmental-monitoring-sdk/go=../indoor-environmental-monitoring-sdk/go
```
...
```go
    result, err := client.EnvironmentalMonitoring(nil).List(nil, nil)
    if err != nil {
        panic(err)
    }
...
### NewIndoorEnvironmentalMonitoringSDK
...
| `EnvironmentalMonitoring` | `(data map[string]any) IndoorEnvironmentalMonitoringEntity` | Create a EnvironmentalMonitoring entity instance. |

### Entity interface (IndoorEnvironmentalMonitoringEntity)

All entities implement the `IndoorEnvironmentalMonitoringEntity` interface.
