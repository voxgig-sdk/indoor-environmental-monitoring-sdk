...
// instead of `sdk.NewIndoorEnvironmentalMonitoringSDK(nil)` / `sdk.TestSDK(nil, nil)`
// for the common no-options case.
func New() *IndoorEnvironmentalMonitoringSDK  { return NewIndoorEnvironmentalMonitoringSDK(nil) }
func Test() *IndoorEnvironmentalMonitoringSDK { return TestSDK(nil, nil) }
