# IndoorEnvironmentalMonitoring Golang SDK Reference

Complete API reference for the IndoorEnvironmentalMonitoring Golang SDK.
...
#### `Test() *IndoorEnvironmentalMonitoringSDK`
...
#### `TestSDK(testopts, sdkopts map[string]any) *IndoorEnvironmentalMonitoringSDK`
...
#### `EnvironmentalMonitoring(data map[string]any) IndoorEnvironmentalMonitoringEntity`
