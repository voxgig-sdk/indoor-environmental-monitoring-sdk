...
type Args struct {
	Entity string         `json:"entity" jsonschema:"environmental_monitoring"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.IndoorEnvironmentalMonitoringSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "indoor-environmental-monitoring_list",
		Description: "List records from IndoorEnvironmentalMonitoring. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "indoor-environmental-monitoring_load",
		Description: "Load a single record from IndoorEnvironmentalMonitoring. " +
...
func runOp(client *sdk.IndoorEnvironmentalMonitoringSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.IndoorEnvironmentalMonitoringSDK, name string) (sdk.IndoorEnvironmentalMonitoringEntity, error) {
	switch strings.ToLower(name) {
	case "environmental_monitoring":
		return client.EnvironmentalMonitoring(nil), nil
