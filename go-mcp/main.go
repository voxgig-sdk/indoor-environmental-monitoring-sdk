// Command IndoorEnvironmentalMonitoring-mcp is an MCP server exposing the IndoorEnvironmentalMonitoring
// SDK as MCP tools.
//
// Two tools are registered:
//
//	IndoorEnvironmentalMonitoring_list  — list records of an entity
//	IndoorEnvironmentalMonitoring_load  — load a single record of an entity
//
