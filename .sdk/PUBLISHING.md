...
|---|---|---|
| `ts/` | @voxgig-sdk/indoor-environmental-monitoring-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/indoor-environmental-monitoring-sdk \
      --repository voxgig-sdk/indoor-environmental-monitoring-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/indoor-environmental-monitoring-sdk` shows it, and
`npm trust revoke @voxgig-sdk/indoor-environmental-monitoring-sdk --id=<id>` removes it.
