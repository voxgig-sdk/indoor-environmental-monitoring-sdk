...
class IndoorEnvironmentalMonitoringTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = IndoorEnvironmentalMonitoringTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = IndoorEnvironmentalMonitoringTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = IndoorEnvironmentalMonitoringTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
