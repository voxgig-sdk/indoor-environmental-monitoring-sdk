# IndoorEnvironmentalMonitoring SDK feature test harness
#
...
class _Ctx:
    ...
    def __init__(self, client, utility, op=None, entity=None, ctrl=None):
        ...
        self.out = {}
        self.ctrl = ctrl if ctrl is not None else IndoorEnvironmentalMonitoringControl()
        self.meta = {}
        self.op = op
        self.entity = entity
        self.spec = None
...
class Harness:
    ...
    def op(self, op="load", entity="widget", method=None, path=None,
        ...
        ctx = _Ctx(self.client, self.utility,
                   ...
                   ctrl=IndoorEnvironmentalMonitoringControl(ctrl or {}))
        ...
        try:
            ...
            if spec is None:
                ...
                for key, val in (headers or {}).items():
                    merged[key] = val
                spec = IndoorEnvironmentalMonitoringSpec({
                    "method": method,
                    "base": self.base,
