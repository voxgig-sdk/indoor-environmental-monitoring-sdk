...
class StructUtilityTest < Minitest::Test
  def setup
    ...
    @runner       = IndoorEnvironmentalMonitoringOmni.make_runner(STRUCT_TEST_JSON_FILE, @client)
  ...
  def test_minor_stringify
    @runsetflags.call(@minor_spec["stringify"], {}, lambda { |vin|
      value = vin.key?("val") ? (vin["val"] == IndoorEnvironmentalMonitoringOmni::NULLMARK ? "null" : vin["val"]) : ""
