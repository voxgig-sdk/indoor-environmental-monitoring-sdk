...
// IndoorEnvironmentalMonitoring SDK utility: make_options

class IndoorEnvironmentalMonitoringMakeOptions
{
    ...
    public static function call(IndoorEnvironmentalMonitoringContext $ctx): array
    {
        ...
        //
        // `IndoorEnvironmentalMonitoringSchema::optspec()` is built from the model:
        ...
        $optspec = IndoorEnvironmentalMonitoringSchema::optspec();
