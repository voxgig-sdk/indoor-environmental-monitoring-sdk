...
// IndoorEnvironmentalMonitoring SDK utility: graphql
//
...
class IndoorEnvironmentalMonitoringGraphql
{
    ...
    // equivalent.
    public static function body(IndoorEnvironmentalMonitoringContext $ctx): mixed
    {
    ...
    public static function errors(IndoorEnvironmentalMonitoringContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
