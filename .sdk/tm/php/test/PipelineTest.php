...
// IndoorEnvironmentalMonitoring SDK pipeline test
//
...
{
    private static function utility(): IndoorEnvironmentalMonitoringUtility
    {
        return new IndoorEnvironmentalMonitoringUtility();
    }
    ...
    private static function ctx(array $over = []): IndoorEnvironmentalMonitoringContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new IndoorEnvironmentalMonitoringContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new IndoorEnvironmentalMonitoringOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof IndoorEnvironmentalMonitoringError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new IndoorEnvironmentalMonitoringOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = IndoorEnvironmentalMonitoringMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new IndoorEnvironmentalMonitoringOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = IndoorEnvironmentalMonitoringMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new IndoorEnvironmentalMonitoringOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = IndoorEnvironmentalMonitoringMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new IndoorEnvironmentalMonitoringSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = IndoorEnvironmentalMonitoringMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        ...
        [, $err] = IndoorEnvironmentalMonitoringMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new IndoorEnvironmentalMonitoringSpec([]),
            'response' => null,
            'result' => new IndoorEnvironmentalMonitoringResult([]),
        ]);
        [, $err] = IndoorEnvironmentalMonitoringMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new IndoorEnvironmentalMonitoringSpec(['step' => 's']),
            'response' => new IndoorEnvironmentalMonitoringResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new IndoorEnvironmentalMonitoringResult([]),
        ]);
        [, $err] = IndoorEnvironmentalMonitoringMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new IndoorEnvironmentalMonitoringSpec(['step' => 's']),
            'response' => new IndoorEnvironmentalMonitoringResponse(self::resp(200, ['v' => 1])),
            'result' => new IndoorEnvironmentalMonitoringResult([]),
        ]);
        [, $err] = IndoorEnvironmentalMonitoringMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new IndoorEnvironmentalMonitoringSpec(['step' => 's']),
            'response' => new IndoorEnvironmentalMonitoringResponse(self::resp(200, ['v' => 2])),
            'result' => new IndoorEnvironmentalMonitoringResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        IndoorEnvironmentalMonitoringMakeResponse::call($ctx);
    ...
    {
        $preset = new IndoorEnvironmentalMonitoringResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new IndoorEnvironmentalMonitoringSpec([]),
            'response' => new IndoorEnvironmentalMonitoringResponse([]),
            'result' => new IndoorEnvironmentalMonitoringResult([]),
        ...
        [$got, $err] = IndoorEnvironmentalMonitoringMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new IndoorEnvironmentalMonitoringResult([])]);
        [, $err] = IndoorEnvironmentalMonitoringMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new IndoorEnvironmentalMonitoringSpec([]), 'result' => null]);
        [, $err] = IndoorEnvironmentalMonitoringMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new IndoorEnvironmentalMonitoringSpec(['step' => 's']),
            'result' => new IndoorEnvironmentalMonitoringResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new IndoorEnvironmentalMonitoringOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = IndoorEnvironmentalMonitoringMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new IndoorEnvironmentalMonitoringSpec(['step' => 's']),
            'result' => new IndoorEnvironmentalMonitoringResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new IndoorEnvironmentalMonitoringOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = IndoorEnvironmentalMonitoringMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new IndoorEnvironmentalMonitoringResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new IndoorEnvironmentalMonitoringSpec([]),
            'result' => new IndoorEnvironmentalMonitoringResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = IndoorEnvironmentalMonitoringMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = IndoorEnvironmentalMonitoringMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new IndoorEnvironmentalMonitoringError('boom', 'boom');
        $utility->fetcher = function (IndoorEnvironmentalMonitoringContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new IndoorEnvironmentalMonitoringSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = IndoorEnvironmentalMonitoringMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (IndoorEnvironmentalMonitoringContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = IndoorEnvironmentalMonitoringMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(IndoorEnvironmentalMonitoringResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        IndoorEnvironmentalMonitoringMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (IndoorEnvironmentalMonitoringContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new IndoorEnvironmentalMonitoringSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = IndoorEnvironmentalMonitoringMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new IndoorEnvironmentalMonitoringResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new IndoorEnvironmentalMonitoringSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = IndoorEnvironmentalMonitoringMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = IndoorEnvironmentalMonitoringMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = IndoorEnvironmentalMonitoringMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new IndoorEnvironmentalMonitoringResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, IndoorEnvironmentalMonitoringDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new IndoorEnvironmentalMonitoringResult(['ok' => false])]);
        $this->expectException(IndoorEnvironmentalMonitoringError::class);
        IndoorEnvironmentalMonitoringDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new IndoorEnvironmentalMonitoringResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', IndoorEnvironmentalMonitoringMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        IndoorEnvironmentalMonitoringMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new IndoorEnvironmentalMonitoringBaseFeature();
        $b = new IndoorEnvironmentalMonitoringBaseFeature();
        IndoorEnvironmentalMonitoringFeatureAdd::call($ctx, $a);
        IndoorEnvironmentalMonitoringFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): IndoorEnvironmentalMonitoringBaseFeature
    {
        $f = new IndoorEnvironmentalMonitoringBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        IndoorEnvironmentalMonitoringFeatureAdd::call($ctx, self::named_feature('a'));
        IndoorEnvironmentalMonitoringFeatureAdd::call($ctx, self::named_feature('b'));
        $this->assertSame(['a', 'b'], $names());

        $before = self::named_feature('z1');
        $before->_options = ['__before__' => 'b'];
        IndoorEnvironmentalMonitoringFeatureAdd::call($ctx, $before);
        $this->assertSame(['a', 'z1', 'b'], $names());

        $after = self::named_feature('z2');
        $after->_options = ['__after__' => 'a'];
        IndoorEnvironmentalMonitoringFeatureAdd::call($ctx, $after);
        $this->assertSame(['a', 'z2', 'z1', 'b'], $names());

        $replace = self::named_feature('z3');
        $replace->_options = ['__replace__' => 'z1'];
        IndoorEnvironmentalMonitoringFeatureAdd::call($ctx, $replace);
        ...
        IndoorEnvironmentalMonitoringFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): IndoorEnvironmentalMonitoringContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new IndoorEnvironmentalMonitoringSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = IndoorEnvironmentalMonitoringPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        IndoorEnvironmentalMonitoringPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new IndoorEnvironmentalMonitoringResponse(['headers' => null]),
            'result' => new IndoorEnvironmentalMonitoringResult([]),
        ]);
        IndoorEnvironmentalMonitoringResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        IndoorEnvironmentalMonitoringResultBody::call($ctx);
