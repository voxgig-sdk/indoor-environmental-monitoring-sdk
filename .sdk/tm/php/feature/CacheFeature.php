...
// IndoorEnvironmentalMonitoring SDK cache feature
...
class IndoorEnvironmentalMonitoringCacheFeature extends IndoorEnvironmentalMonitoringBaseFeature
{
    ...
    private function _through(IndoorEnvironmentalMonitoringContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
