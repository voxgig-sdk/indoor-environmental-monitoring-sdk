...
// IndoorEnvironmentalMonitoring SDK clienttrack feature
...
class IndoorEnvironmentalMonitoringClienttrackFeature extends IndoorEnvironmentalMonitoringBaseFeature
{
    ...
    public function PostConstruct(IndoorEnvironmentalMonitoringContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'IndoorEnvironmentalMonitoring-SDK';
