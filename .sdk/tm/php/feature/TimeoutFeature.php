...
// IndoorEnvironmentalMonitoring SDK timeout feature
...
class IndoorEnvironmentalMonitoringTimeoutFeature extends IndoorEnvironmentalMonitoringBaseFeature
{
    ...
    private function _with_timeout(IndoorEnvironmentalMonitoringContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(IndoorEnvironmentalMonitoringContext $_ctx, float $ms): void
    {
        $client = $this->client;
