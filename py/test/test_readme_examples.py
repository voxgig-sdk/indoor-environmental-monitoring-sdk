# IndoorEnvironmentalMonitoring SDK — root README python-examples test.
#
...
def test_readme_python_blocks_typecheck():
    ...
    with tempfile.TemporaryDirectory() as td:
        ...
        # Resolve "from indoorenvironmentalmonitoring_sdk import IndoorEnvironmentalMonitoringSDK" against the package root.
...
def test_readme_testmode_snippets_run():
    ...
    for i, block in enumerate(blocks):
        ...
        namespace = {"IndoorEnvironmentalMonitoringSDK": IndoorEnvironmentalMonitoringSDK, "os": os}
        try:
