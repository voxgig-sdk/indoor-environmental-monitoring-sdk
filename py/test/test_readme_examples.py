# IndoorEnvironmentalMonitoring SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions IndoorEnvironmentalMonitoringSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both IndoorEnvironmentalMonitoringSDK(...) and IndoorEnvironmentalMonitoringSDK.test(...) become
#      IndoorEnvironmentalMonitoringSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "indoorenvironmentalmonitoring_sdk"
_SDK_CLASS = "IndoorEnvironmentalMonitoringSDK"
