...
from indoorenvironmentalmonitoring_sdk.utility import register

# Load features
from indoorenvironmentalmonitoring_sdk.feature.base_feature import IndoorEnvironmentalMonitoringBaseFeature
from indoorenvironmentalmonitoring_sdk.features import _has_feature, _make_feature
...
class IndoorEnvironmentalMonitoringSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = IndoorEnvironmentalMonitoringUtility()
    ...
    def get_utility(self):
        return IndoorEnvironmentalMonitoringUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("IndoorEnvironmentalMonitoringSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def EnvironmentalMonitoring(self, data=None) -> "EnvironmentalMonitoringEntity":
        ...
        from indoorenvironmentalmonitoring_sdk.entity.environmental_monitoring_entity import EnvironmentalMonitoringEntity
