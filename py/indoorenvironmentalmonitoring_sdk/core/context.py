...
from indoorenvironmentalmonitoring_sdk.core.helpers import get_ctx_prop, to_map
...
class IndoorEnvironmentalMonitoringContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = IndoorEnvironmentalMonitoringControl()
        ...
        if isinstance(sp, IndoorEnvironmentalMonitoringSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, IndoorEnvironmentalMonitoringResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, IndoorEnvironmentalMonitoringResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return IndoorEnvironmentalMonitoringOperation({})
    ...
    def make_error(self, code, msg):
        return IndoorEnvironmentalMonitoringError(code, msg, self)
