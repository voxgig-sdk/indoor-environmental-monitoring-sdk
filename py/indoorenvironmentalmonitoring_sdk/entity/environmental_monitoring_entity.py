...
from indoorenvironmentalmonitoring_sdk.indoorenvironmentalmonitoring_types import (
...
class EnvironmentalMonitoringEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return EnvironmentalMonitoringEntity(self._client, opts)
    ...
    def data_get(self) -> EnvironmentalMonitoring:
    ...
    def match_get(self) -> EnvironmentalMonitoring:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[EnvironmentalMonitoring]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.EnvironmentalMonitoring().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
