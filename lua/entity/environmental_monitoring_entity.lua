...
local EnvironmentalMonitoringEntity = {}
EnvironmentalMonitoringEntity.__index = EnvironmentalMonitoringEntity


function EnvironmentalMonitoringEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, EnvironmentalMonitoringEntity)
  self._name = "environmental_monitoring"
  self._client = client
...
function EnvironmentalMonitoringEntity:get_name()
  return self._name
end


function EnvironmentalMonitoringEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return EnvironmentalMonitoringEntity.new(self._client, opts)
end
...
function EnvironmentalMonitoringEntity:mark_deleted()
  self._deleted = true
end


function EnvironmentalMonitoringEntity:deleted()
  return true == self._deleted
end


function EnvironmentalMonitoringEntity:data_set(args)
  if args ~= nil then
...
function EnvironmentalMonitoringEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function EnvironmentalMonitoringEntity:match_set(args)
  if args ~= nil then
...
function EnvironmentalMonitoringEntity:match_get()
...
function EnvironmentalMonitoringEntity:stream(action, args, callopts)
...
function EnvironmentalMonitoringEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return EnvironmentalMonitoringEntity
