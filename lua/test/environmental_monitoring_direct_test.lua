...
describe("EnvironmentalMonitoringDirect", function()
  it("should direct-list-environmental_monitoring", function()
    local setup = environmental_monitoring_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-environmental_monitoring", setup.live and "live" or "unit")
...
function environmental_monitoring_direct_setup(mockres)
