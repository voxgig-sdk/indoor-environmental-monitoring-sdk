# IndoorEnvironmentalMonitoring Lua SDK Reference

Complete API reference for the IndoorEnvironmentalMonitoring Lua SDK.
...
```lua
local results, err = client:EnvironmentalMonitoring(nil):list(nil, nil)
```
